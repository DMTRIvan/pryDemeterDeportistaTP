...
namespace pryDemeterDeportistasTP
{
    ...
    {
        //conexion permite conectarnos con la base de datos
        private OleDbConnection Conexion = new OleDbConnection();
        //comand le envia una orden a la base de dato
        private OleDbCommand Comando = new OleDbCommand();
        // adaptador: convierte los datos que estan en la base de dato
